...
<!--
Thank you for reporting a possible bug in wp-image-sources.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "WP Image Sources" in the list of plugins. The version number will be listed under the plugin description.
-->
